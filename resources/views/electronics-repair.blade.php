...
<?php
    ...
    $crumb = "Repairs";
    $crumbLink = "/repairs";
    $imageMain = '<img src="media/garage-opener.png"; class="img-responsive" alt="Electronics">';
    $priceMain = "Please call/text/email";
    $descMain = "Have an electronic device your unsure about fixing? Let the experts at iTech take care of it for you! There is nothing we can't fix!";
    $taxMain = ""; // leave blank if no tax

 ?>

@section('title', 'Electronics Repair') <!-- Remember to change this -->
