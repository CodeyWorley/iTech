...
<?php
    ...
    $crumb = "Repairs";
    $crumbLink = "/repairs";
    $imageMain = '<img src="media/macbook.png"; class="img-responsive" alt="Mac Repair">';
    ...
    $imageTwo = '<img src="media/imac.png"; class="img-responsive" alt="Mac Repair">';
    $imageThree = '<img src="media/mac-mini.png"; class="img-responsive" alt="Mac Repair">';
 ?>

@section('title', 'Mac Repair') <!-- Remember to change this -->
                ...
                <div class="col-md-4">
                    <div class="row" style="padding-top:20px">
                        ...
                        <div class="col-xs-2">
                            ...
                            <option value='<?php echo $imageMain; ?>'>Macbook
                            <option value='<?php echo $imageTwo; ?>'>iMac
                            <option value='<?php echo $imageThree; ?>'>Mac Mini
                            </select>
                        </div>
                    </div>
