...
<?php
    ...
    $crumb = "Repairs";
    $crumbLink = "/repairs";
    $imageMain = '<img src="media/apple-watch.png"; class="img-responsive" alt="Smart Watch">';
    ...
    $imageTwo = '<img src="media/fossil.png"; class="img-responsive" alt="Smart Watch">';
    $imageThree = '<img src="media/garmin.png"; class="img-responsive" alt="Health Tracker">';

 ?>

@section('title', 'Smart Watch Repair') <!-- Remember to change this -->
                    ...
                    <div class="row" style="padding-top:20px">
                        ...
                        <div class="col-xs-2">
                            <select id="typeSelect" class="form-control" onchange="changeImage()"> <!-- Edit for each -->
                                <option value='<?php echo $imageMain; ?>'>Apple Watch
                                <option value='<?php echo $imageTwo; ?>'>Other Watch
                                <option value='<?php echo $imageThree; ?>'>Health tracker
                            </select>
                        </div>
                    </div>
