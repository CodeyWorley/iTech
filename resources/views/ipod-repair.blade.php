...
<?php
    ...
    $crumb = "Repairs";
    $crumbLink = "/repairs";
    $imageMain = '<img src="media/ipod-touch.png"; class="img-responsive" alt="iPod">';
    ...
    $imageTwo = '<img src="media/ipod-classic.png"; class="img-responsive" alt="iPod">';

 ?>

@section('title', 'iPod Repair') <!-- Remember to change this -->
                    ...
                    <div class="row" style="padding-top:20px">
                        ...
                        <div class="col-xs-2">
                            <select id="typeSelect" class="form-control" onchange="changeImage()"> <!-- Edit for each -->
                                <option value='<?php echo $imageMain; ?>'>iPod Touch
                                <option value='<?php echo $imageTwo; ?>'>iPod Classic
                            </select>
                        </div>
                    </div>
