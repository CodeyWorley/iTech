...
<?php
    ...
    $crumb = "Services";
    $crumbLink = "/services";
    $imageMain = '<img src="media/router.png"; class="img-responsive" alt="Network Services">';
    $priceMain = "$65";
    $descMain = "Has your internet slowed down over the years? A new modem/router can do wonders for your speeds. Let the experts at iTech take a look to see if you are in need of an upgrade! All installs and troubleshooting are tailored specifically to your unique needs.";
    $taxMain = "+ tax"; // leave blank if no tax

 ?>

@section('title', 'Network Services') <!-- Remember to change this -->
