...
<?php
    ...
    $crumb = "Repairs";
    $crumbLink = "/repairs";
    $imageMain = '<img src="media/ipad.png"; class="img-responsive" alt="iPad">';
    $priceMain = "Please call/text/email";
    $descMain = "Does your device have a cracked screen and/or not responsive to touch? We can fix that in an hour with our glass repair service! This repair does not include the lcd. Feel free to ask for more details.";
    $taxMain = ""; // leave blank if no tax

    $imageTwo = '<img src="media/ipad-mini.png"; class="img-responsive" alt="iPad Mini';
    $imageThree = '<img src="media/ipad-air.png"; class="img-responsive" alt="iPad Air';
    $imageFour = '<img src="media/ipad-pro.png"; class="img-responsive" alt="iPad Pro';
 ?>

@section('title', 'iPad Repair') <!-- Remember to change this -->
            ...
            function changeImage() {
                ...
                if (image == '<?php echo $imageMain; ?>') {
                    ...
                    if (fix == 'glass'){
                        ...
                        document.getElementById("details").innerHTML = glass;
                    ...
                    if (fix == 'chargeport'){
                        document.getElementById("price").innerHTML = parts;
                ...
                if (image == '<?php echo $imageTwo; ?>') {
                    ...
                    if (fix == 'lcd'){
                        document.getElementById("price").innerHTML = "$149";
                        document.getElementById("details").innerHTML = lcd;
                        document.getElementById("tax").innerHTML = tax;
                    }
                    if (fix == 'battery'){
                    ...
                    <div class="row" style="padding-top:20px">
                        ...
                        <div class="col-xs-2">
                            <select id="typeSelect" class="form-control" onchange="changeImage()"> <!-- Edit for each -->
                                <option value='<?php echo $imageMain; ?>'>All Models
                            </select>
                        </div>
                    </div>
