...
<!-- PHP variables -->
<?php
    $name = "Computer Clean Up";
    $type = "Service";
    $crumb = "Services";
    $crumbLink = "/services";
    $imageMain = '<img src="media/laptop.png"; class="img-responsive" alt="Computer Clean Up">';
    $priceMain = "$55";
...
@section('title', 'Computer Clean Up') <!-- Remember to change this -->
