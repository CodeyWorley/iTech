...
<?php
    ...
    $crumb = "Services";
    $crumbLink = "/services";
    $imageMain = '<img src="media/printer.png"; class="img-responsive" alt="Printer Services">';
    $priceMain = "$65";
    $descMain = "Do you have a printer giving you dificulties? Whether it's installing a new one or keeping an old one working, printers can be dificult for anyone. Let the experts at itech save you the frustration with our quick easy servicing!";
    $taxMain = "+ tax"; // leave blank if no tax

 ?>

@section('title', 'Printer Services') <!-- Remember to change this -->
