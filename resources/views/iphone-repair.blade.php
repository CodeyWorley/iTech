...
<?php
    ...
    $crumb = "Repairs";
    $crumbLink = "/repairs";
    $imageMain = '<img src="media/iphone-7.png"; class="img-responsive" alt="iPhone">';
    $priceMain = "$139";
    ...
    $imageTwo = '<img src="media/iphone-7-plus.png"; class="img-responsive" alt="iPhone">';
    $imageThree = '<img src="media/iphone-6s.png"; class="img-responsive" alt="iPhone">';
    $imageFour = '<img src="media/iphone-6s-plus.png"; class="img-responsive" alt="iPhone">';
    $imageFive = '<img src="media/iphone-6.png"; class="img-responsive" alt="iPhone">';
    $imageSix = '<img src="media/iphone-6-plus.png"; class="img-responsive" alt="iPhone">';
    $imageSeven = '<img src="media/iphone-5.png"; class="img-responsive" alt="iPhone">';
 ?>

@section('title', 'iPhone Repair') <!-- Remember to change this -->

<!-- End veriables -->

@section('styles') <!-- need to fix this eventually -->
@endsection
        ...
        <script>
            function changeImage() {
                ...
                if (image == '<?php echo $imageMain; ?>') {
                    ...
                    if (fix == 'lcd'){
                        document.getElementById("price").innerHTML = "$139";
                        document.getElementById("details").innerHTML = lcd;
                        document.getElementById("tax").innerHTML = tax;
                    }
                    if (fix == 'battery'){
                        document.getElementById("price").innerHTML = batteryPrice;
                        document.getElementById("details").innerHTML = battery;
                        document.getElementById("tax").innerHTML = tax;
                    }
                    if (fix == 'chargeport'){
                        document.getElementById("price").innerHTML = "$79";
                        document.getElementById("details").innerHTML = chargeport;
                        document.getElementById("tax").innerHTML = tax;
                    }
                    if (fix == 'water'){
                ...
                if (image == '<?php echo $imageTwo; ?>') {
                    var fix = document.getElementById("fixSelect").value;
                    if (fix == 'lcd'){
                        document.getElementById("price").innerHTML = "$169";
                        document.getElementById("details").innerHTML = lcd;
                        document.getElementById("tax").innerHTML = tax;
                    }
                    if (fix == 'battery'){
                ...
                //iphone 6s
                if (image == '<?php echo $imageThree; ?>') {
                    var fix = document.getElementById("fixSelect").value;
                    if (fix == 'lcd'){
                        document.getElementById("price").innerHTML = "$109";
                        document.getElementById("details").innerHTML = lcd;
                        document.getElementById("tax").innerHTML = tax;
                    }
                    if (fix == 'battery'){
                ...
                if (image == '<?php echo $imageSeven; ?>') {
                    ...
                    if (fix == 'chargeport'){
                        document.getElementById("price").innerHTML = "$39";
                        document.getElementById("details").innerHTML = chargeport;
                        document.getElementById("tax").innerHTML = tax;
                    }
                    if (fix == 'water'){
                    ...
                    <div class="row" style="padding-top:20px;">
                        ...
                        <div class="col-xs-2">
                            <select id="typeSelect" class="form-control" onchange="changeImage()"> <!-- Edit for each -->
                                <option value='<?php echo $imageMain; ?>'>iPhone 7
                                <option value='<?php echo $imageTwo; ?>'>iPhone 7 Plus
                                <option value='<?php echo $imageThree; ?>'>iPhone 6s
                                <option value='<?php echo $imageFour; ?>'>iPhone 6s Plus
                                <option value='<?php echo $imageFive; ?>'>iPhone 6
                                <option value='<?php echo $imageSix; ?>'>iPhone 6 Plus
                                <option value='<?php echo $imageSeven; ?>'>iPhone 5/5s/5c
                            </select>
                        </div>
                    </div>
