...
<?php
    ...
    $crumb = "Services";
    $crumbLink = "/services";
    $imageMain = '<img src="media/monitor.png"; class="img-responsive" alt="IT Services">';
    $priceMain = "$75";
    $descMain = "Have an IT issue you just can't figure out? Let the experts at iTech have a look! There is no problem too big or too small we can't handle for you!";
    $taxMain = "+ tax"; // leave blank if no tax

 ?>

@section('title', 'IT Services') <!-- Remember to change this -->
