...
<?php
    ...
    $crumb = "Repairs";
    $crumbLink = "/repairs";
    $imageMain = '<img src="media/wii-u.png"; class="img-responsive" alt="Console">';
    $priceMain = "$109";
    $descMain = "Does your device have trouble reading discs? Over time the mechanical parts and even the optical sensor can go bad in any console. Let the experts at iTech get your device back to its full potential!";
    $taxMain = "+ tax"; // leave blank if no tax

    $imageTwo = '<img src="media/xbox-one-x.png"; class="img-responsive" alt="Console">';
    $imageThree = '<img src="media/ps4-pro.png"; class="img-responsive" alt="Console">';
 ?>

@section('title', 'Console Repair') <!-- Remember to change this -->
            ...
            function changeImage() {
                ...
                if (image == '<?php echo $imageMain; ?>') {
                    ...
                    if (fix == 'diskDrive'){
                        ...
                        document.getElementById("details").innerHTML = diskDrive;
                    ...
                    <div class="row" style="padding-top:20px">
                        ...
                        <div class="col-xs-2">
                            <select id="typeSelect" class="form-control" onchange="changeImage()"> <!-- Edit for each -->
                                <option value='<?php echo $imageMain; ?>'>Wii
                                <option value='<?php echo $imageTwo; ?>'>Xbox
                                <option value='<?php echo $imageThree; ?>'>Play Station
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top:20px">
                        ...
                        <div class="col-xs-2">
                            <select id="fixSelect" class="form-control" onchange="changeImage()"> <!-- Edit for each -->
                                <option value="diskDrive">Disk Drive
                                <option value="hardDrive">Hard Drive
                                <option value="ports">Broken Ports
